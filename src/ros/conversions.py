...
def matrix2image(matrix, frame_id, time, encoding = "passthrough"):
    global __bridge
...
def image2matrix(image, encoding = "passthrough"):
    global __bridge
    return np.array(__bridge.imgmsg_to_cv2(image, encoding))
